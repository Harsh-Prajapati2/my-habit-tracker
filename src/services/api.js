...
export const tasksAPI = {
  ...
  updateTopic: (id, data) => apiClient.put(`/tasks/topics/${id}`, data),
  deleteTopic: (id) => apiClient.delete(`/tasks/topics/${id}`),
...
export const goalsAPI = {
  ...
  updateTopic: (id, data) => apiClient.put(`/goals/topics/${id}`, data),
  deleteTopic: (id) => apiClient.delete(`/goals/topics/${id}`),
